  ...
  weeks: [
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          embedUrl: "https://embed.app.guidde.com/playbooks/15mmL2a5XhaivTgBHkpgFc?mode=videoAndDoc",
          transcript: []
        },
        {
          id: "w1-l2",
          title: "Navigating the Clay Interface",
          embedUrl: "https://embed.app.guidde.com/playbooks/15mmL2a5XhaivTgBHkpgFc?mode=videoAndDoc&lesson=w1-l2",
          transcript: []
        },
        {
            id: "w1-l3",
      ...
      lessons: [
        {
          ...
          embedUrl: "https://embed.app.guidde.com/playbooks/15mmL2a5XhaivTgBHkpgFc?mode=videoAndDoc&lesson=w2-l1",
          transcript: []
        },
        {
          id: "w2-l2",
          title: "Enriching Data with LinkedIn",
          embedUrl: "https://embed.app.guidde.com/playbooks/15mmL2a5XhaivTgBHkpgFc?mode=videoAndDoc&lesson=w2-l2",
          transcript: []
        },
        {
          id: "w2-l3",
          ...
          description: "This table enriches lead data from webhooks with additional information such as job titles, executive classifications, and country codes. It leverages AI and external APIs to segment leads, determine their region membership, and gather recent LinkedIn posts.",
          transcript: []
        }
      ]
    },
    {
      ...
      lessons: [
        ...
        },
        {
            ...
            embedUrl: "https://studio.modernagencysales.com/form/deployment-8d5de8e9-4ca2-4b0d-90c4-5a5f9843e300",
            description: "Interact with this AI agent directly within the dashboard. This lesson demonstrates how to embed external Pickaxe/Agency Sales tools.",
            transcript: []
        }
      ]
    }
