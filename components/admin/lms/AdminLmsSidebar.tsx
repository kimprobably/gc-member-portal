...
import { FolderKanban, BookOpen, ArrowLeft, X, GraduationCap } from 'lucide-react';
import { useTheme } from '../../../context/ThemeContext';

interface AdminLmsSidebarProps {
  isOpen: boolean;
  onClose: () => void;
}
...
const AdminLmsSidebar: React.FC<AdminLmsSidebarProps> = ({ isOpen, onClose }) => {
...
export default AdminLmsSidebar;
